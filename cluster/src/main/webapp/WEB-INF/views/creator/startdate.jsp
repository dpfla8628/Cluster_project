...
<script>
	$(document).ready(function(){
			...
			$("#btnUpdate").on("click", function(){
				formObj.attr("action", "/creator/startdatemodify")
            ...
            <div class="item-wrapper">
                <div class="row mb-3">
                    <div class="col-md-8 mx-auto">	
						<form:form modelAttribute="offclass" action="startdatemodify" method="post">
							...
							<div class="form-group row showcase_row_area">
	                            ...
	                            <div class="col-md-9 showcase_content_area mb-2 pl-1">
	                                <div class="demo-wrapper">
	                                    <div id="datepicker-popup" class="input-group date datepicker"><form:input type="date" class="form-control" path="classStart"/> <span class="input-group-addon input-group-append"></span></div>
	                                </div>
	                            </div>
	                        </div>
