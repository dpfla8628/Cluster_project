	...
	$(document).ready(function(){
	    $("#sort").on("change", function(){
			...
			if (queryParams.subcategory) {
                self.location = "/study?subcategory=" + queryParams.subcategory + "&sort=" + this.value;
                return;
            }
            self.location = "/study?sort=" + this.value;
		})
      ...
      function getUrlParams() {
	    ...
	    $(".detail").css("cursor","pointer").on("click", function(){
	    	...
	    	/* to-do
	    	self.location = "/study?classNo=" + ${classNo}.value; */ 
...
<div class="d-flex" id="wrapper">
	...
	<div class="border-right" id="sidebar-wrapper">
		<div class="sidebar-heading">스터디</div>
		
		<div class="list-group list-group-flush">
			<a href="/study?subcategory=토익" class="list-group-item list-group-item-action bg-light">토익</a>
			<a href="/study?subcategory=토플" class="list-group-item list-group-item-action bg-light">토플</a>
			<a href="/study?subcategory=자바" class="list-group-item list-group-item-action bg-light border-bottom">자바</a>
		</div>
	</div>
